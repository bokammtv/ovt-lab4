...
function setFormValues(form, taskId, action) {
...
window.onload = function () {
    ...
    taskModal.addEventListener('show.bs.modal', function (event) {
        ...
        if (action == 'edit' || action == 'show') {
            setFormValues(form, event.relatedTarget.closest('.task').id, action);
    ...
    let removeTask = document.getElementById('remove-task-modal');
    removeTask.addEventListener('show.bs.modal', function (event) {
